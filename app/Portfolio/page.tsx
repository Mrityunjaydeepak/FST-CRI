...
export default function Portfolio() {
  ...
  return (
    <div className='flex flex-col px-4 sm:px-8 md:px-16 my-24 lg:px-32 justify-center space-y-8'>
      ...
      >
        ...
        <motion.div
          ...
          style={{ backgroundImage: `url(${contImg.src})`, zIndex: -1 }}
          initial={{ y: 0 }}
      ...
      >
        <motion.p
          className="text-base sm:text-lg md:text-xl lg:text-2xl text-white cursor-pointer"
